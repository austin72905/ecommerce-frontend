...
export default function handler(req:NextApiRequest, res:NextApiResponse) {
    ...
    if (req.method === 'POST') {
      ...
      res.redirect(302,`${apiUrl}/checkout?LogisticsSubType=${LogisticsSubType}&CVSStoreName=${encodeURIComponent(CVSStoreName)}&CVSAddress=${encodeURIComponent(CVSAddress)}`)
    } else {
